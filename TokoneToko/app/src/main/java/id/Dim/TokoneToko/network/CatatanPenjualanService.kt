package id.rdev.Dim.network

import id.rdev.Dim.activity.data_barang.data.ResultDataBarang
import id.rdev.Dim.activity.login.data.ResultLogin
import id.rdev.Dim.activity.penjualan.data.ResultKeranjang
import id.rdev.Dim.activity.penjualan.data.ResultSearchBarang
import id.rdev.Dim.activity.report.detail.data.ResultItemKeranjang
